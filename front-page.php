		...
		<section id="about-nina" class="main__about">
			...
			<section class="card-design fadeIn">
				...
				<p class="about-nina__description card-design__description">
					...
					&ensp;SLE患者さんの抱える問題の１つとして日光過敏症に対して、少しでも快適に外出が出来るよう寄贈する傘は、「nina」で販売するアクセサリーの売り上げの一部を資金として使用致します。
				</p>
			</section>
			...
			<section class="about-nina__details__contents card-design fadeIn">
				...
				<p class="about-umbrella__description card-design__description mgtp">
					&ensp;紫外線暴露が病気の悪化につながる患者さんにとっては、少しでも体のダメージを軽減することに役立つ日傘と言えます。そして、生地が破れるまで、その遮光率は落ちません。<br>
					&ensp;そんな貴重な生地を使用した遮光100%の日傘の価格帯は、約1万円〜となります。
				</p>
				<p class="about-umbrella__description card-design__description mgtp">
			...
			<section class="about-nina__details__contents card-design fadeIn">
				...
				<p class="about-comments__description card-design__description mgtp">
					...
					&ensp;自宅にいながら、私たち患者とこの病気をまだ知らない、たくさんの方が繋がる方法はないだろうか、と考えた時、大好きなアクセサリーが思い浮かびました。
				</p>
				<p class="about-comments__description card-design__description mgtp">
					私自身も全身性エリテマトーデスを始め、食物アレルギーや、体調によっては金属アレルギーも出ることがあります。<br>
					&ensp;今回は、比較的金属アレルギーの出にくいとされる、14kgf (14金ゴールドフィルド)と言う素材を主に使用する事にしました。<br>
					&ensp;全ての方にアレルギーが起こらない保証はありませんが、金メッキとは違い、ゴールドフィルド素材のコーティングの厚さや製法は、錆び難く劣化しにくいものになっています。
				</p>
				<p class="about-comments__description card-design__description mgtp">
					&ensp;「nina」のアクセサリーを手に取って頂いた事をキッカケに、SLEの事を知ってもらい、たくさんの方に病気を理解して貰えたら、結果として、患者さんがより普通に、ナチュラルに皆さんと社会で交われると思います。
				</p>
				<p class="about-comments__description card-design__description mgtp">
					&ensp;私たちは助けが必要なのではありません。知ってもらえれば、それだけで充分に、大きな助けになります。理解を得られるだけで、病気を個性として生きられると、私は思っています。<br>
					&ensp;全身性エリテマトーデス(SLE/Lupus)の方へ日傘を届けるプロジェクトにご賛同いただいた方が、このプロジェクトに参加したと言う思い出とともに、nina のアクセサリーを長く愛用して頂けるよう、制作に全力を尽くしますので、サポートの程よろしくお願い致します！
				</p>
			</section>
		...
		<section id="about-sle" class="main__about fadeIn">
			...
			<div class="about-sle__details card-design">
				...
				<p class="about-sle__description card-design__description mgtp">
					膠原病のひとつとして知られている国の指定難病、全身性エリテマトーデス(英名の頭文字を取ってSLE/英語で通称Lupus)の症状はきわめて多彩で、“全身性”という病名のとおり、全身の様々な臓器に障害を起こしやすいという特徴があります。<br>
					&ensp;ただし、現れる症状やその組み合わせ、重症度などは個々の患者さんによって異なります。<br>
					&ensp;病気の悪化、または再熱の原因として、紫外線暴露・ストレス・睡眠不足・疲れ等が挙げられ、患者は日頃から日中の外出を控えたり、最善の紫外線対策をしての外出を求められます。
				</p>
