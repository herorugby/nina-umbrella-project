        ...
        <section id="workshop" class="main__workshop">
            ...
            <section class="workshop__details__contents card-design fadeIn">
                ...
                <p class="workshop__description--mgtp card-design__description">
                    &ensp;ninaで制作するアクセサリーに使用する素材は以下の通りです。<br>
            ...
            <section class="workshop__details__contents card-design fadeIn">
                ...
                <p class="workshop__description card-design__description">
                    &ensp;手軽に本物の金の輝きを楽しめる、欧米ではポピュラーな素材です。<br>
                    金属の総重量のうち、1/20以上が14金で出来ている金張り加工のことを言います。<br>
                    &ensp;また、通常の金メッキよりはるかに金の層が厚く、長期間使用しても剥がれることなく金属アレルギーに優しい素材とされています。<br>
                    その輝きはゴールドアクセサリーと程近く、美しいと言われています。
                </p>
                <p class="workshop__description card-design__description mgtp">
            ...
            <section class="workshop__details__contents card-design fadeIn">
                ...
                <p class="workshop__description_care card-design__description">
                    &ensp;14kgfは、ゴールドアクセサリーと同様、着用後に柔らかいコットンや布（メガネ用の布がおすすめ）で、包み込むように汗や皮脂を拭き取ることで美しく長く使用する事ができます。<br>
                    &ensp;アクセサリーを身に着けたままお風呂に入るのは、劣化を加速させる原因となることがあります。
                </p>
                <p class="workshop__description_care card-design__description mgtp">
                    &ensp;天然石や真珠が付いている場合は、破損防止のため優しくお手入れしてください。<br>
                    &ensp;普段のお手入れは拭くだけで結構ですが、長く愛用しているうちに稀に酸化して黒ずみが気になる可能性があります。その場合は市販のジュエリークリーナーの使用をお勧めします。
                </p>
            </section>
            ...
            <section class="workshop__details__contents card-design fadeIn">
                ...
                <p class="workshop__description_care card-design__description">
                    &ensp;繊細な天然パーツや柔らかい14kgfのピアスポスト、連結パーツを使用しておりますので、お取り扱いには十分お気をつけ下さい。<br>
